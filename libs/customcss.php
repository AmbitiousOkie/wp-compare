...
if ($menu_font_color != '') {
    print '.signuplink,#access ul.menu >li>a,#submit_action,#access a,#access ul ul a,#access .menu li:hover>a,#access .menu li:hover>a:active, #access .menu li:hover>a:focus{color:#'.$menu_font_color.';}';  
} 
...
$transparent_menu_font_color    =   esc_html ( get_option('wp_estate_transparent_menu_font_color','') );    
    ...
    print '.transparent_header #access a{
            color: #' . $transparent_menu_font_color . '!important;
        }';
    }
    ...
    if($sticky_header_height!=''){
        print'.header_wrapper.customnav,
            ...
            .hover_type_6 .customnav #access ul li:hover > ul{
                top:' . ( $sticky_header_height-23) . 'px;
            }
            ';
        }
