...
if( !function_exists('wpestate_my_booking_columns') ):
    function wpestate_my_booking_columns( $columns ) {
        ...
        $columns['booking_estate_status']   = esc_html__( 'Status','wpestate');
...
function wpestate_payments_management(){
    ...
    print'
        ...
        <div class="col-md-1 payment_management_head">
            '.esc_html__('Invoice No').'
        </div>

        <div class="col-md-1 payment_management_head">
            '.esc_html__('Total Price').'
        </div>

        <div class="col-md-1 payment_management_head">
            '.esc_html__('To Be Paid').'
        </div>

        <div class="col-md-1 payment_management_head">
            '.esc_html__('Security Deposit').'
        </div>

        <div class="col-md-1 payment_management_head">
            '.esc_html__('Balance Invoice ID').'
        </div>';
